...
public class DomandeTirocinioServiceTest {
  ...
  //crea domanda di tirocinio #4
    DomandaTirocinio domanda4 = new DomandaTirocinio();
    domanda4.setCfu(6);
    domanda4.setCommentoStudente("Mi piace il progetto!");
    domanda4.setData(LocalDateTime.now());
    domanda4.setInizioTirocinio(LocalDate.of(2018, 3, 1));
    domanda4.setFineTirocinio(LocalDate.of(2018, 3, 31));
    domanda4.setStudente(studente);
    domanda4.setStatus(DomandaTirocinio.VALIDATA);
    domanda4.setProgettoFormativo(progetto);
    
  //crea domanda di tirocinio #5
    DomandaTirocinio domanda5 = new DomandaTirocinio();
    domanda5.setCfu(6);
    domanda5.setCommentoStudente("Mi piace il progetto!");
    domanda5.setData(LocalDateTime.now());
    domanda5.setInizioTirocinio(LocalDate.of(2018, 3, 1));
    domanda5.setFineTirocinio(LocalDate.of(2018, 3, 31));
    domanda5.setStudente(studente);
    domanda5.setStatus(DomandaTirocinio.ANNULLATA);
    domanda5.setProgettoFormativo(progetto);
    ...
    //Crea lista contenente domande validate
    List<DomandaTirocinio> listaDomandeValidate = new ArrayList<DomandaTirocinio>();
    listaDomandeValidate.add(domanda4);
    
    //Crea lista contenente domande annullate
    List<DomandaTirocinio> listaDomandeAnnullate = new ArrayList<DomandaTirocinio>();
    listaDomandeAnnullate.add(domanda5);
    ...
    listaDomande.add(domanda4);
    listaDomande.add(domanda5);
    ...
    //Stabilisce che il metodo findAllByStatusAndProgettoFormativoAziendaId restituisca
    //listaDomandeValidate
    when(domandaRepository.findAllByStatusAndProgettoFormativoAziendaId(DomandaTirocinio.VALIDATA,
        "azienda")).thenReturn(listaDomandeValidate);
  //Stabilisce che il metodo findAllByStatusAndProgettoFormativoAziendaId restituisca
    //listaDomandeAnnullate
    when(domandaRepository.findAllByStatusAndProgettoFormativoAziendaId(DomandaTirocinio.ANNULLATA,
        "azienda")).thenReturn(listaDomandeAnnullate);
  ...
  public void testElencaTirociniInCorsoStudente() {
    ...
    domanda.setCommentoStudente("Mi piace il progetto!");
    domanda.setData(LocalDateTime.now());
    domanda.setInizioTirocinio(LocalDate.of(2020, 1, 1));
    domanda.setFineTirocinio(LocalDate.of(2020, 12, 31));
    domanda.setStudente(studente);
    ...
    domanda2.setCommentoStudente("Mi piace il progetto!");
    domanda2.setData(LocalDateTime.now());
    domanda2.setInizioTirocinio(LocalDate.of(2020, 1, 1));
    domanda2.setFineTirocinio(LocalDate.of(2020, 12, 31));
    domanda2.setStudente(studente);
    domanda2.setStatus(DomandaTirocinio.VALIDATA);
    domanda2.setProgettoFormativo(progetto);
    ...
    when(domandaRepository.findAllByStatusAndStudenteUsername(DomandaTirocinio.VALIDATA,
        "FrancescoF")).thenReturn(listaDomande);
  ...
  public void testElencaTirociniInCorsoImpiegato() {
    ...
    when(domandaRepository.findAllByStatus(DomandaTirocinio.VALIDATA)).thenReturn(listaDomande);
  ...
  @Test
    ...
    studente.setDataDiNascita(LocalDate.of(1990, 12, 12));
    studente.setDataRegistrazione(LocalDateTime.of(2017, 12, 25, 23, 45));
    studente.setEmail("wykzqrt@gmail.com");
    studente.setIndirizzo("Via francesco, 9");
    studente.setMatricola("0512103434");
    studente.setTelefono("3331234123");
    studente.setSesso(Studente.SESSO_MASCHILE);
  ...
  /**
   * Testa il metodo che permette al Presidente del Consiglio Didattico di validare una 
   * domanda di tirocinio.
   * 
   * @test {@link DomandeTirocinioService#validaDomandaTirocinio(long)}
   * 
   * @result Il test è superato se la domanda viene validata con successo
   * 
   */
  @Test (expected = NullPointerException.class)
  public void testValidaDomandaTirocinio() 
    ...
    //Crea Presidente Consiglio Didattico
    ...
    domanda.setCommentoStudente("Mi piace il progetto!");
    domanda.setData(LocalDateTime.now());
    domanda.setInizioTirocinio(LocalDate.of(2020, 3, 1));
    domanda.setFineTirocinio(LocalDate.of(2020, 3, 31));
    domanda.setStudente(studente);
    domanda.setStatus(DomandaTirocinio.APPROVATA);
    domanda.setProgettoFormativo(progetto);
    
    //Permette di stabilire che l'operazione è eseguita dal Presidente del Consiglio Didattico
    ...
    try {
      domandeService.validaDomandaTirocinio(11111L);
    } catch (IdDomandaTirocinioNonValidoException e) {
      fail(e.getMessage());
      e.printStackTrace();
    } catch (StatoDomandaNonIdoneoException e) {
   ...
   */
  @Test(expected = IdDomandaTirocinioNonValidoException.class)
  public void testValidaDomandaConIdNonValido() throws IdDomandaTirocinioNonValidoException {
    ...
    //Crea Presidente del Consiglio Didattico
    PresidenteConsiglioDidattico presidente = new PresidenteConsiglioDidattico();
    presidente.setNome("Filomena");
    presidente.setCognome("Ferrucci");
    presidente.setEmail("fferrucci@unisa.it");
   ...
   */
  @Test(expected = RichiestaNonAutorizzataException.class)
  public void testValidaDomandaRichiestaNonAutorizzata() throws RichiestaNonAutorizzataException {
   ...
   */
  @Test(expected = StatoDomandaNonIdoneoException.class)
  public void testValidaDomandaConStatoNonIdoneo() throws StatoDomandaNonIdoneoException {
   ...
   */
  @Test
  public void testAnnullaDomandaTirocinio() {
    ...
    when(domandaRepository.findById(11111L)).thenReturn(domanda);
    try {
      domandeService.annullaDomandaTirocinio(11111L, "commentoPresidente");
    } catch (IdDomandaTirocinioNonValidoException e) {
      fail(e.getMessage());
      e.printStackTrace();
    } catch (StatoDomandaNonIdoneoException e) {
   ...
   */
  @Test(expected = IdDomandaTirocinioNonValidoException.class)
  public void testAnnullaDomandaConIdNonValido() throws IdDomandaTirocinioNonValidoException {
   ...
   */
  @Test(expected = StatoDomandaNonIdoneoException.class)
  public void testAnnullaDomandaConStatoNonIdoneo() throws StatoDomandaNonIdoneoException {
   ...
   */
  @Test(expected = RichiestaNonAutorizzataException.class)
  public void testAnnullaDomandaRichiestaNonAutorizzata() throws RichiestaNonAutorizzataException {
   ...
   */
  @Test(expected = CommentoDomandaTirocinioNonValidoException.class)
  public void testAnnullaDomandaConCommentoNonValido() 
      throws CommentoDomandaTirocinioNonValidoException {
    ...
    when(domandaRepository.findById(11111L)).thenReturn(domanda);
    try {
      domandeService.annullaDomandaTirocinio(11111L, "");
    } catch (IdDomandaTirocinioNonValidoException e) {
      fail(e.getMessage());
      e.printStackTrace();
    } catch (StatoDomandaNonIdoneoException e) {
   ...
   */
  @Test
  public void elencaDomandeRicevutePresidente() {
    
	//Crea Presidente del Consiglio Didattico
	PresidenteConsiglioDidattico presidente = new PresidenteConsiglioDidattico();
	presidente.setNome("Antonio");
	presidente.setCognome("Masola");
	presidente.setEmail("antonio@masola.com");
	presidente.setUsername("username");
	presidente.setPassword("password");  
   ...
   */
  @Test
  public void testElencaDomandeInviateImpiegato() {
	  
	//Crea impiegato dell'ufficio tirocini
	    ImpiegatoUfficioTirocini impiegato = new ImpiegatoUfficioTirocini();
	    impiegato.setNome("impiegato");
	    impiegato.setCognome("impiegato");
	    impiegato.setEmail("ufficiotirocini@unisa.it");
	    impiegato.setUsername("ufficiotirocini");
	    impiegato.setPassword("ufficiotirocini"); 
    ...
    domanda1.setCfu(6);
    domanda1.setCommentoStudente("Mi piace il progetto!");
    domanda1.setData(LocalDateTime.now());
    domanda1.setInizioTirocinio(LocalDate.of(2018, 3, 1));
    domanda1.setFineTirocinio(LocalDate.of(2018, 3, 31));
    domanda1.setStudente(studente);
    domanda1.setStatus(DomandaTirocinio.VALIDATA);
    domanda1.setProgettoFormativo(progetto);
  ...
  //crea domanda di tirocinio #2
    ...
    domanda3.setFineTirocinio(LocalDate.of(2018, 3, 31));
    domanda3.setStudente(studente);
    domanda3.setStatus(DomandaTirocinio.ANNULLATA);
    domanda3.setProgettoFormativo(progetto);
    
    //Crea lista contenente domande approvate
    List<DomandaTirocinio> listaDomandeApprovate = new ArrayList<DomandaTirocinio>();
    listaDomandeApprovate.add(domanda2);
    
    //Crea lista contenente domande validata
    List<DomandaTirocinio> listaDomandeValidate = new ArrayList<DomandaTirocinio>();
    listaDomandeValidate.add(domanda1);    
    
    //Crea lista contenente domande annullate
    List<DomandaTirocinio> listaDomandeAnnullate = new ArrayList<DomandaTirocinio>();
    listaDomandeAnnullate.add(domanda3);
    ...
    //Stabilisce che il metodo findAllByStatusAndProgettoFormativoAziendaId restituisca
    //listaDomandeApprovate
    when(domandaRepository.findAllByStatus(DomandaTirocinio.APPROVATA))
    														.thenReturn(listaDomandeApprovate);
    //Stabilisce che il metodo findAllByStatusAndProgettoFormativoAziendaId restituisca
    //listaDomandeValidate
    when(domandaRepository.findAllByStatus(DomandaTirocinio.VALIDATA))
    														.thenReturn(listaDomandeValidate);
  //Stabilisce che il metodo findAllByStatusAndProgettoFormativoAziendaId restituisca
    //listaDomandeAnnullate
    when(domandaRepository.findAllByStatus(DomandaTirocinio.ANNULLATA))
    														.thenReturn(listaDomandeAnnullate);
    //Stabilisce che l'utente autenticato al momento dell'invocazione del metodo sia un delegato
    when(utenzaService.getUtenteAutenticato()).thenReturn(impiegato);
    try {
      //Verifica che gli oggetti appartenenti alle due liste siano uguali
   ...
   */
  @Test
  public void testElencaTirociniInCorsoPresidente() {
