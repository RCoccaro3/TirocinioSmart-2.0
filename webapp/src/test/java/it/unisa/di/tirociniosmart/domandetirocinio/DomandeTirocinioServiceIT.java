...
public class DomandeTirocinioServiceIT {
  ...
  @Autowired 
  private PresidenteConsiglioDidatticoRepository presidenteRepository;
  ...
  public void registraDomandaTirocinio() {
    ...
    delegato.setEmail("wykzqrt@gmail.com");
  ...
  public void elencaDomandeRicevute() {
    ...
    try {
      domanda = domandeService.approvaDomandaTirocinio(domanda.getId());
      domanda2 = domandeService.approvaDomandaTirocinio(domanda2.getId());
    } catch (IdDomandaTirocinioNonValidoException | RichiestaNonAutorizzataException |
    		StatoDomandaNonIdoneoException e) {
      fail(e.getMessage());
    }
    ...
    try {
        List<DomandaTirocinio> domandeOttenutePresidente = domandeService.elencaDomandeRicevute();
        assertThat(listaDomande, is(equalTo(domandeOttenutePresidente)));
      } catch (RichiestaNonAutorizzataException e) {
        fail(e.getMessage());
        e.printStackTrace();
      }
  ...
  public void elencaDomandeInviate() {
    ...
    System.out.println(utenzaService.getUtenteAutenticato());
  ...
  //Effettua login dell'impiegato
    ...
    try {
        List<DomandaTirocinio> domandeImpiegato = domandeService.elencaDomandeInviate();
        assertThat(listaDomande, everyItem(isIn(domandeImpiegato)));
      } catch (RichiestaNonAutorizzataException e) {
        fail(e.getMessage());
      }
  ...
  /**
   * Testa il metodo che permette al presidente del consiglio didattico di annullare una domanda 
   * di tirocinio.
   * 
   * @test {@link DomandeTirocinioService#annullaDomandaTirocinio(long, String)}
   * 
   * @result il test è superato se la domanda di tirocinio viene annullata correttamente 
   * 
   */
  @Test
  public void annullaDomandaTirocinio() {
    // Crea un azienda
    Azienda azienda = new Azienda();
    azienda.setId("starkind");
    azienda.setNome("Stark Industries");
 ...
 // Effettua il login come impiegato
    ...
    assertThat(domanda.getStatus(), is(equalTo(DomandaTirocinio.VALIDATA)));
  }
  
  
  /**
   * Testa il metodo che permette al presidente del consiglio didattico di validare una domanda 
   * di tirocinio.
   * 
   * @test {@link DomandeTirocinioService#validaDomandaTirocinio(long, String)}
   * 
   * @result il test è superato se la domanda di tirocinio viene validata correttamente 
   * 
   */
  @Test
  public void validaDomandaTirocinio() {
    // Crea un azienda
    Azienda azienda = new Azienda();
    azienda.setId("starkind");
    azienda.setNome("Stark Industries");
 ...
 // Effettua il login come impiegato
  ...
  public void elencaTirociniInCorso() {
    ...
    PresidenteConsiglioDidattico presidente = new PresidenteConsiglioDidattico();
    presidente.setUsername("fferruci");
    presidente.setPassword("fferrucci");
    ...
    // Effettua logout del presidente
    utenzaService.logout();
