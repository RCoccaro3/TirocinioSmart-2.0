...
public class UtenzaService {
  ...
  public UtenteRegistrato getUtenteAutenticato() {  
    ...
    // Controlla se l'username è associato al Presidente
    utente = presidenteRepository.findByUsername(username);
    if (utente != null) {
      return utente;
    }
  ...
  public void login(String username, String password)
    ...
    utente = presidenteRepository.findByUsernameAndPassword(username, password);
    if (utente != null) {
      AutenticazioneHolder.setUtente(username);
      return;
    }
