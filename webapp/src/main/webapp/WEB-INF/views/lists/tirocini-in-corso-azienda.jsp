...
<spring:message var="tooltipRegistroTirocinio" code="tooltip.registroTirocinio" />
	  ...
	  <li>
	    ...
	    <div class="collapsible-header">
	     ...
	     <div class="col s1 right-align">       
       		<a href="/dashboard/tirocini/registro/${current.id}" class="tooltipped tooltipped-icon" 
		               data-position="left"
		               data-delay="50" 
		               data-tooltip="${tooltipRegistroTirocinio}">		                
