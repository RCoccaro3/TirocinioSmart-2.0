...
<spring:message var="tooltipAttivitàAggiungi" code="tooltip.attivita.aggiungi" />
...
<main> 
  <div class="row">
    <div class="col l4 xl3">
      ...
      <jsp:include page="/WEB-INF/views/menu/studente-dashboard.jsp" />
    ...
    <div class="col s12 m12 l8 xl9">
      <div class="card single-row-header">
        ...
        <div class="card-image">
          ...
          <c:if test="${utente.getClass().getSimpleName() == 'Studente'}">
          <c:choose>
          <c:when test="${rimanenti > 0}">
              <a class="modal-trigger halfway-fab btn-floating btn-large waves-effect waves-light red tooltipped"
                 data-delay="50"
                 data-position="left"
                 href="#aggiungi-attività-tirocinio"
                 data-tooltip="${tooltipAttivitàAggiungi}">
      ...
      <jsp:include page="/WEB-INF/views/lists/attivita-tirocinio-studente.jsp"/>
  ...
  <jsp:include page="/WEB-INF/views/forms/aggiunta-attività-tirocinio.jsp" >
    ...
    <jsp:param name="idRegistro" value="${registro.id}"/>
  </jsp:include>
